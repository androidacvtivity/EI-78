(function ($) {
    ...
    // }
        ...
        // Call the function for 44-0030 validation
        const ExportValidationErrors = validateDuplicateExportCodes(values);

        // Push errors to webform.errors if validation fails
        if (ExportValidationErrors) {
            ExportValidationErrors.forEach(error => webform.errors.push(error));
        }
